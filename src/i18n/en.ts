...
export const en: Translations = {
  ...
  'admin.detail_section_persoonsgegevens': 'Personal details',
  'admin.detail_section_account': 'Account info',
  'admin.detail_section_activity': 'Activity',
  'admin.detail_activity_created': 'Account created',
  'admin.detail_activity_invited': 'Invitation sent',
  'admin.detail_activity_submitted': 'Data submitted',
  'admin.detail_activity_activated': 'Activated',
  'admin.detail_activity_reminder': 'Reminder sent',
  ...
  'admin.bulk_select_label': 'Select',
  'admin.bulk_select_all_label': 'Select all visible authors',
  'admin.bulk_select_all_hint': '{count} authors visible — tick to delete',
  'admin.bulk_selected_count': '{n} selected',
  'admin.bulk_clear': 'Clear selection',
  'admin.bulk_delete_button': 'Delete {n}',
  'admin.bulk_delete_status_success': '{n} authors deleted.',
  'admin.bulk_delete_heading': 'Delete {count} authors?',
  'admin.bulk_delete_body':
    'This action removes {count} accounts including all royalty statements, contracts, expenses and historical data. This cannot be undone.',
  'admin.bulk_delete_preview_more': '… and {n} more',
  'admin.bulk_delete_progress': 'Deleting ({current} of {total})…',
  'admin.bulk_delete_confirm': 'Permanently delete',
  'admin.bulk_delete_result_heading': 'Done',
  'admin.bulk_delete_result_body': '{success} of {total} authors deleted.',
  ...
  'admin.contract_upload_heading': 'Upload contract for {name}',
  'admin.contract_upload_intro':
    'Enter at minimum the contract number and select the PDF. You can fill in the remaining metadata later via Supabase Dashboard if not handy now.',
  'admin.contract_upload_field_number': 'Contract number *',
  'admin.contract_upload_field_name': 'Contract name (optional)',
  'admin.contract_upload_field_royalty': 'Royalty percentage (optional)',
  'admin.contract_upload_field_start': 'Start date (optional)',
  'admin.contract_upload_field_end': 'End date (optional)',
  'admin.contract_upload_field_pdf': 'PDF file *',
  'admin.contract_upload_submit': 'Upload contract',
  'admin.contract_upload_success': 'Contract added for {name}.',
  'admin.contract_upload_error_no_number': 'Contract number is required.',
  'admin.contract_upload_error_no_pdf': 'Please select a PDF file.',
  'admin.contract_upload_error_not_pdf': 'Only PDF files are allowed.',
  'admin.contract_upload_error_too_large': 'File exceeds 25 MB.',
  'admin.contract_upload_error_upload_failed': 'Upload failed',
  'admin.contract_upload_error_insert_failed': 'Database insert failed',
  ...
  'admin.id_koppel_heading': 'Link IDs for {name}',
  'admin.id_koppel_intro': 'Enter the NetSuite Vendor ID and Alliant ID. Both can be edited later.',
  ...
  'admin.bulk_stmt_amounts_help_heading': 'Help: what goes in the Excel?',
  'admin.bulk_stmt_amounts_help_intro':
    "One row per PDF: alliant_id of the author, amount (in euros), and yyyymm (year + month from the filename). For two PDFs of the same author in different months you'll add two rows.",

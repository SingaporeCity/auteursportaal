...
export const nl: Translations = {
  ...
  'expenses.history_download': 'Bekijk PDF',
  'expenses.download_heading': '1. Download het juiste formulier',
  'expenses.upload_heading': '2. Upload het ingevulde formulier als PDF',
  'expenses.types_help_summary': 'Welk formulier moet ik kiezen?',
  'expenses.form_onkosten_title': 'Onkostenformulier',
  'expenses.form_onkosten_desc': 'Reiskosten · bureaukosten · incidenteel',
  'expenses.form_onkosten_explanation':
    'Voor alle losse, niet-projectgebonden uitgaven die je hebt gemaakt voor Noordhoff: reiskosten (auto/OV), kleine bureaukosten (printerinkt, kantoorartikelen) en incidentele kosten. Voeg altijd de originele bonnen of facturen toe als bijlage in het PDF. Kilometers reken je af volgens de ANWB-routeplanner tegen 21 ct/km.',
  'expenses.form_idc_title': 'Projectkosten (IDC)',
  'expenses.form_idc_desc': 'Redactiewerk · projectmatig',
  'expenses.form_idc_explanation':
    'Voor werkzaamheden die als project worden gefactureerd: redactiewerk, projectmatig auteurschap, lessenmaak-opdrachten of andere kosten die aan een lopend IDC-project (Internal Development Cost) verbonden zijn. Vermeld altijd het PO-nummer van het project in de declaratie, anders kan Noordhoff de kosten niet aan een budget koppelen.',
  'expenses.form_idc_required_hint': 'PO-nummer altijd vermelden',
  'expenses.rule_originals_title': 'Originele bonnen of facturen',
  'expenses.rule_originals_text': 'altijd meesturen bij de declaratie.',
  'expenses.rule_pdfonly_title': 'Alleen digitaal in PDF',
  'expenses.rule_pdfonly_text':
    'declaraties kunnen alleen als PDF via dit portaal worden ingediend. Fysieke declaraties of MS Word/Excel-bestanden worden niet in behandeling genomen.',
  'expenses.rule_km_title': 'Kilometervergoedingen',
  'expenses.rule_km_text': 'opgeven volgens de ANWB Routeplanner tegen 21 cent per kilometer.',
  'expenses.rule_btw_title': 'Omzetbelasting (BTW)',
  'expenses.rule_btw_text':
    'gebruik dit formulier alleen als u niet bent aangemerkt als ondernemer voor de BTW. Bent u dat wel? Stuur dan uw eigen factuur met daarop minimaal de "brand" en "cost center".',
  'expenses.error_no_file': 'Selecteer een PDF van het ingevulde formulier.',
  'expenses.error_not_pdf': 'Alleen PDF-bestanden toegestaan.',
  'expenses.error_too_large': 'Bestand is groter dan 10 MB.',
  'expenses.error_no_session': 'Geen actieve sessie. Log opnieuw in.',
  'expenses.error_upload_failed': 'Upload faalde',
  'expenses.error_insert_failed': 'Indienen faalde',
  'expenses.uploading': 'Bezig met uploaden…',
  'expenses.sending_mail': 'Verzenden naar Noordhoff…',
  'expenses.success': 'Declaratie ingediend en gemaild naar rights@noordhoff.nl.',
  'expenses.success_no_mail':
    'Declaratie ingediend in het portaal, maar de mail naar Noordhoff is niet verstuurd. Noordhoff ziet de declaratie nog wel via het admin-overzicht.',

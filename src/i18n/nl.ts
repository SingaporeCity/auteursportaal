...
export const nl: Translations = {
  ...
  'onboarding.banner_blocking_title': 'Welkom bij Noordhoff',
  'onboarding.banner_blocking_text':
    'Fijn dat u er bent. Om uw account te kunnen activeren hebben we nog enkele persoonsgegevens van u nodig: adres, IBAN, BIC en BSN. Vul deze hieronder aan op uw profielpagina; zodra alles compleet is, gaan wij voor u aan de slag.',
  ...
  'onboarding.field_required': 'Dit veld is verplicht.',
  ...
  'validate.email_invalid': 'Ongeldig e-mailadres. Verwacht: naam@voorbeeld.nl.',
  ...
  'profile.label_house_number': 'Huisnummer',
  ...
  'profile.placeholder_phone': 'Bijv. +31 6 12345678',
  'profile.placeholder_street': 'Straatnaam',
  'profile.placeholder_house_number': 'Nummer (en eventuele toevoeging)',
  'profile.placeholder_postcode': '1234 AB',
  'profile.placeholder_city': 'Plaatsnaam',
  'profile.placeholder_country': 'Bijv. Nederland',
  'profile.placeholder_bsn': '9 cijfers, zonder spaties',
  'profile.placeholder_iban': 'NL12 ABCD 1234 5678 90',
  'profile.placeholder_bic': '8 of 11 tekens, bijv. ABNANL2A',
  ...
  'admin.detail_section_persoonsgegevens': 'Persoonsgegevens',
  'admin.detail_section_account': 'Accountgegevens',
  'admin.detail_section_activity': 'Activiteit',
  'admin.detail_activity_created': 'Account aangemaakt',
  'admin.detail_activity_invited': 'Uitnodiging verstuurd',
  'admin.detail_activity_submitted': 'Gegevens ingediend',
  'admin.detail_activity_activated': 'Geactiveerd',
  'admin.detail_activity_reminder': 'Herinnering verstuurd',
  ...
  'admin.bulk_select_label': 'Selecteer',
  'admin.bulk_select_all_label': 'Selecteer alle zichtbare auteurs',
  'admin.bulk_select_all_hint': '{count} auteurs zichtbaar — vink aan om te verwijderen',
  'admin.bulk_selected_count': '{n} geselecteerd',
  'admin.bulk_clear': 'Selectie wissen',
  'admin.bulk_delete_button': 'Verwijder {n}',
  'admin.bulk_delete_status_success': '{n} auteurs verwijderd.',
  'admin.bulk_delete_heading': '{count} auteurs verwijderen?',
  'admin.bulk_delete_body':
    'Deze actie verwijdert {count} accounts inclusief alle royaltystatements, contracten, declaraties en historische gegevens. Dit kan niet ongedaan worden gemaakt.',
  'admin.bulk_delete_preview_more': '… en nog {n} meer',
  'admin.bulk_delete_progress': 'Bezig met verwijderen ({current} van {total})…',
  'admin.bulk_delete_confirm': 'Definitief verwijderen',
  'admin.bulk_delete_result_heading': 'Klaar',
  'admin.bulk_delete_result_body': '{success} van {total} auteurs verwijderd.',
  ...
  'admin.contract_upload_heading': 'Contract uploaden voor {name}',
  'admin.contract_upload_intro':
    'Vul minimaal het contractnummer in en kies de PDF. De overige metadata mag je later aanvullen via Supabase Dashboard als je die nu nog niet bij de hand hebt.',
  'admin.contract_upload_field_number': 'Contractnummer *',
  'admin.contract_upload_field_name': 'Contractnaam (optioneel)',
  'admin.contract_upload_field_royalty': 'Royaltypercentage (optioneel)',
  'admin.contract_upload_field_start': 'Ingangsdatum (optioneel)',
  'admin.contract_upload_field_end': 'Einddatum (optioneel)',
  'admin.contract_upload_field_pdf': 'PDF-bestand *',
  'admin.contract_upload_submit': 'Upload contract',
  'admin.contract_upload_success': 'Contract toegevoegd voor {name}.',
  'admin.contract_upload_error_no_number': 'Contractnummer is verplicht.',
  'admin.contract_upload_error_no_pdf': 'Selecteer een PDF-bestand.',
  'admin.contract_upload_error_not_pdf': 'Alleen PDF-bestanden toegestaan.',
  'admin.contract_upload_error_too_large': 'Bestand is groter dan 25 MB.',
  'admin.contract_upload_error_upload_failed': 'Upload faalde',
  'admin.contract_upload_error_insert_failed': 'Database-insert faalde',
  ...
  'admin.tooltip_id_koppelen':
    'Vul Vendor ID en Alliant ID in om deze auteur aan NetSuite te koppelen.',
  'admin.id_koppel_heading': 'IDs koppelen voor {name}',
  'admin.id_koppel_intro':
    'Vul de NetSuite Vendor ID en Alliant ID in. Beide kunnen later nog worden gewijzigd.',

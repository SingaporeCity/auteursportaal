...
export const nl: Translations = {
  ...
  'admin.filter_pending_review': 'Wacht op review',
  'admin.filter_pending_data': 'Wacht op auteur',
  'admin.filter_active': 'Actief',
  'admin.btn_send_invite': 'Stuur uitnodiging',
  ...
  'admin.reminder_in_days': 'Reminder beschikbaar over {days} dagen',

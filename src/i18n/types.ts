...
export type TranslationKey =
  ...
  | 'admin.btn_activate'
  | 'admin.btn_reset_mfa'
  | 'admin.btn_delete_author'
  | 'admin.tooltip_delete_author'
  | 'admin.delete_author_heading'
  | 'admin.delete_author_body'
  | 'admin.delete_author_confirm'
  | 'admin.delete_author_success'
  | 'admin.delete_author_error'
  | 'admin.delete_author_error_self'
  | 'admin.bulk_select_label'
  | 'admin.bulk_select_all_label'
  | 'admin.bulk_select_all_hint'
  | 'admin.bulk_selected_count'
  | 'admin.bulk_clear'
  | 'admin.bulk_delete_button'
  | 'admin.bulk_delete_status_success'
  | 'admin.bulk_delete_heading'
  | 'admin.bulk_delete_body'
  | 'admin.bulk_delete_preview_more'
  | 'admin.bulk_delete_progress'
  | 'admin.bulk_delete_confirm'
  | 'admin.bulk_delete_result_heading'
  | 'admin.bulk_delete_result_body'
  ...
  | 'admin.status_id_koppelen'
  | 'admin.status_id_koppelen_short'
  | 'admin.btn_id_koppelen'
  | 'admin.tooltip_id_koppelen'
  | 'admin.id_koppel_heading'
  | 'admin.id_koppel_intro'
  | 'admin.id_koppel_field_vendor'
  | 'admin.id_koppel_field_alliant'
  | 'admin.id_koppel_submit'
  | 'admin.id_koppel_success'
  | 'admin.id_koppel_error'
